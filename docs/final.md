...
Lastly we built a simpler agent that used traditional techniques to construct the blueprint, as a baseline to measure the trained agents against. The logic for this agent is as follows:
